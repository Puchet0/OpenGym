...
export default {
  ...
  'Pick a predefined routine to get started. You can always change it later.': 'Elegí una rutina predefinida para empezar. Siempre podés cambiarla después.',
  'Plan loaded: {0}': 'Plan cargado: {0}',
  'Load routine': 'Cargar rutina',
  'Pick one or several predefined routines.': 'Elegí una o varias rutinas predefinidas.',
  'Routine loaded: {0}': 'Rutina cargada: {0}',
  '{0} routines loaded': '{0} rutinas cargadas',
  'Load {0}': 'Cargar {0}',
  '{0} exercises · {1} days': '{0} ejercicios · {1} días',
